...
export default function SocialDock() {
  return (
    <div className="social-dock-bottom">
      ...
      <Item href={site.socials.facebook} label="Facebook" delay={1.3} />
      <Item href={site.socials.youtube} label="YouTube" delay={1.6} />
      <Item href={site.socials.spotify} label="Spotify" delay={1.9} />
