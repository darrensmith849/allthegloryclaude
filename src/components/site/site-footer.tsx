        ...
        <div className="mx-auto max-w-md flex flex-col gap-6">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-6 mb-5">
              ...
              {/* Apple Music — same search-URL fallback the social dock +
                  album streaming row use, so the icon works today and
                  auto-upgrades to the direct artist link the moment
                  site.socials.appleMusic gets a real value. */}
              <a
                href={
