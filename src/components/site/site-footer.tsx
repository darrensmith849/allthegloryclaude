  ...
  return (
    <footer className="relative w-full overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 md:py-20">
        ...
        {/* Social + nav + credits — all in glass */}
        <div className="mx-auto max-w-2xl panel-scrim p-6 md:p-8">
          {/* Social links */}
          ...
          {/* Artwork credit */}
          <p className="text-center text-xs mb-3" style={{ color: "var(--colour-ink)", opacity: 0.35 }}>
            Artwork by{" "}
            <a
