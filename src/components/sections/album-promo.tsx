    ...
    <section className="bg-transparent">
      <div className="mx-auto w-full max-w-6xl px-6 py-10 md:py-14">
        <Link
          ...
          className="block panel-scrim p-6 md:p-8 grid gap-6 md:grid-cols-[360px_1fr] items-center group hover:border-white/20 transition-colors duration-300"
        >
          {/* Album image */}
          <div>
          ...
          <div>
            ...
            <div className="mt-6 text-xs uppercase tracking-[0.24em] text-white/55 group-hover:text-white/80 transition-colors duration-300">
              Listen now →
            </div>
          </div>
        </Link>
