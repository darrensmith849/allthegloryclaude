  ...
  return (
    <main className="bg-transparent">
      <div className="mx-auto w-full max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-white/70">Support new music and future albums.</p>
        ...
        <div className="mt-8 panel-scrim p-6">
          ...
          <p className="mt-4 text-xs text-white/55">
            Donations go straight into recording, production, and releasing new music — not just plays.
          </p>
        </div>
      </div>
    </main>
